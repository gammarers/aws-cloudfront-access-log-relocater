...
| <code><a href="#@gammarers/aws-cloudfront-access-log-relocater.CloudFrontAccessLogRelocater.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="@gammarers/aws-cloudfront-access-log-relocater.CloudFrontAccessLogRelocater.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="@gammarers/aws-cloudfront-access-log-relocater.CloudFrontAccessLogRelocater.with.parameter.mixins"></a>
